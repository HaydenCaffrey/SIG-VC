...
# Dataset
#dataset = "LJSpeech"
data_path = "/Netdata/yangyg/dataset/cmu_data/vctk/"
embed_type = 'resnet_embeds'

### multi-speaker
spk_embedding = False #True
gvector_dim = 256
dataset = "bnf-mel"
...
sv_model_name = 'ResNet34SE' #ECAPA-TDNN ResNet34SE
sv_model_type = 'ResNet34SEStatsPool'
in_planes = 64 # ResNet34SE in_planes=64,ECAPA-TDNN = 80
embd_dim = 256
spkembd_weight = 3
